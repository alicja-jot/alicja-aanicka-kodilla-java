...
public class GlutenFreeShop implements Shop {
    ...
    public ResponseDto orderInShop(RequestDto requestDto) {
        System.out.println("Obsluzone przez GlutenFreeShop. Produkt: " + requestDto.getProduct().getName() + " ilosc: " + requestDto.getAmount());
        return new ResponseDto(true, new Supplier("GlutenFreeShop"));
    }
}