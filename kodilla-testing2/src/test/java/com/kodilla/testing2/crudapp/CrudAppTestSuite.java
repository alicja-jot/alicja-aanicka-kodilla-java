...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://alicja-jot.github.io/";
    ...
    private void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    WebElement fieldset = theForm.findElement(By.xpath(".//fieldset[contains(@class, \"datatable__row-section--button-section\")]"));
                    WebElement deleteButton = fieldset.findElement(By.xpath(".//button[4]"));
                    deleteButton.click();
                });
        Thread.sleep(5000);
    }
